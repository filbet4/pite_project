...
pitch_axis = 0.0
while True:
    rate_of_correction = random.randrange(0.0, 45.0)
    roll_axis = random.gauss(0,2*rate_of_correction)
    print(f"the orientation was corrected by {rate_of_correction}")
    print(f"current orientation is {roll_axis} degrees")